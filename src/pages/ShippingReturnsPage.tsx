    ...
    <div className="bg-offWhite">
      <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Orders are processed within 1-2 business days. You will receive a notification when your order has shipped.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Shipping charges for your order will be calculated and displayed at checkout.</p>
                <ul className="list-disc list-inside text-gray-600 mt-2 space-y-1">
                  <li><span className="font-medium">Punjab:</span> 2-3 business days (Rs 200, free over Rs 2500)</li>
                  <li><span className="font-medium">Other Provinces:</span> 3-5 business days (Rs 300, free over Rs 2500)</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg space-y-6">
            <p className="text-gray-600">We have a 30-day return policy, which means you have 30 days after receiving your item to request a return.</p>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600">To start a return, you can contact us at <a href="mailto:hello@breathin.store" className="text-sageGreen hover:underline">hello@breathin.store</a>. If your return is accepted, we’ll send you instructions on how and where to send your package.</p>
            </div>
             <div>
